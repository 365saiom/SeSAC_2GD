...
/* 5. Array 배열 */
let fruits = ["orange", "kiwi", "mange", "apple"];
...
console.log(typeof n3+" isn't " + typeof n4+" data type");
console.log("typeof를 boolean 이나 null 에 사용하면, "+typeof cat + "결과를 얻을 수 있습니다.")
...
alert("평균 점수는 "+Number(avgScore)+"이다.");